...
including the repository itself (issues, pull requests, discussions,
commits) — and also applies when an individual is officially representing
the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported by opening a [GitHub Discussion](https://github.com/RedPandaGuy1234/Games/discussions)
and @mentioning `RedPandaGuy1234`, asking for a private channel to discuss
the report. Please do not post details of the incident publicly in the
discussion itself. All complaints will be reviewed and investigated promptly
and fairly.
